...
participant DB
    ...
    Note over Service: usersName, usersDescription,<br/>usersBirthday, gender, profileImageUrl
...
| **필드 업데이트** | `Service`는 **null이 아닌 필드만 선택적으로 업데이트**합니다. | **부분 업데이트 (Partial Update)** |
